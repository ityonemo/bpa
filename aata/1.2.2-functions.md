            ...
            assume injective(g) {
              @given-f-injective |
                assume injective(f) {
                  ...
                  @injective-unfolds |
                    forall h: Fn;
                      injective(h) iff (forall a, b: Element; apply(h, a) = apply(h, b) -> a = b)
                    [by axiom injectiveDef]
                  @g-injective-unfolds |
                    injective(g) iff (forall a, b: Element; apply(g, a) = apply(g, b) -> a = b)
                    [by forall_elim(g) injective-unfolds]
                  @g-injective-gives-pointwise |
                    injective(g) -> (forall a, b: Element; apply(g, a) = apply(g, b) -> a = b)
                    [by iff_elim_forward g-injective-unfolds]
                  @g-is-injective |
                    injective(g)
                  ...
                  @composite-injective-unfolds |
                    injective(compose(g, f)) iff (forall a, b: Element; apply(compose(g, f), a) = apply(compose(g, f), b) -> a = b)
                  ...
                  @pointwise-injective-gives-injective |
                    ...
                    [by iff_elim_backward composite-injective-unfolds]
            ...
            assume surjective(g) {
              @given-f-surjective |
                assume surjective(f) {
                  @surjective-unfolds |
                    forall h: Fn;
                      surjective(h) iff (forall y: Element; exists x: Element; apply(h, x) = y)
                    [by axiom surjectiveDef]
                  @g-surjective-unfolds |
                    surjective(g) iff (forall y: Element; exists x: Element; apply(g, x) = y)
                  ...
                  @g-surjective-gives-pointwise |
                    ...
                    [by iff_elim_forward g-surjective-unfolds]
                  @g-is-surjective |
                    surjective(g)
                  ...
                  @f-surjective-unfolds |
                    surjective(f) iff (forall y: Element; exists x: Element; apply(f, x) = y)
                  ...
                  @f-surjective-gives-pointwise |
                    ...
                    [by iff_elim_forward f-surjective-unfolds]
                  @f-is-surjective |
                    surjective(f)
                  ...
                  @composite-surjective-unfolds |
                    surjective(compose(g, f)) iff (forall y: Element; exists x: Element; apply(compose(g, f), x) = y)
                  ...
                  @pointwise-surjective-gives-surjective |
                    ...
                    [by iff_elim_backward composite-surjective-unfolds]
        ...
        assume invertible(f) {
          ...
          @with-inverse-g |
            unpack g: Fn from inverse-exists {
              ...
              @injective-unfolds |
                forall ff: Fn;
                  injective(ff) iff (forall a, b: Element; apply(ff, a) = apply(ff, b) -> a = b)
                [by axiom injectiveDef]
              @f-injective-unfolds |
                injective(f) iff (forall a, b: Element; apply(f, a) = apply(f, b) -> a = b)
                [by forall_elim(f) injective-unfolds]
              @pointwise-injective-gives-injective |
                ...
                [by iff_elim_backward f-injective-unfolds]
              @f-is-injective |
                injective(f)
        ...
        assume invertible(f) {
          ...
          @with-inverse-g |
            unpack g: Fn from inverse-exists {
              ...
              @surjective-unfolds |
                forall ff: Fn;
                  surjective(ff) iff (forall y: Element; exists x: Element; apply(ff, x) = y)
                [by axiom surjectiveDef]
              @f-surjective-unfolds |
                surjective(f) iff (forall y: Element; exists x: Element; apply(f, x) = y)
                [by forall_elim(f) surjective-unfolds]
              @pointwise-surjective-gives-surjective |
                ...
                [by iff_elim_backward f-surjective-unfolds]
              @f-is-surjective |
                surjective(f)
    ...
    fix f: Fn {
      @given-bijective |
        assume injective(f) and surjective(f) {
          ...
          @injective-forward |
            injective(f) -> (forall a, b: Element; apply(f, a) = apply(f, b) -> a = b)
            [by iff_elim_forward injective-def-at-f]
          ...
          @surjective-forward |
            surjective(f) -> (forall y: Element; exists x: Element; apply(f, x) = y)
            [by iff_elim_forward surjective-def-at-f]
