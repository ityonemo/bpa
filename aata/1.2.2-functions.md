        ...
        fix g: Fn {
          @generalize-f |
            fix f: Fn {
              ...
              @extensionality |
                forall p, q: Fn;
                  (forall x: Element; apply(p, x) = apply(q, x)) -> p = q
                [by axiom funcExt]
            ...
            assume injective(g) {
              @given-f-injective |
                assume injective(f) {
                  ...
                  @injective-unfolds |
                    forall h: Fn;
                      (injective(h) -> (forall a, b: Element; apply(h, a) = apply(h, b) -> a = b))
                      and ((forall a, b: Element; apply(h, a) = apply(h, b) -> a = b) -> injective(h))
                    [by axiom injectiveDef]
                  @g-injective-unfolds |
                    (injective(g) -> (forall a, b: Element; apply(g, a) = apply(g, b) -> a = b))
                      and ((forall a, b: Element; apply(g, a) = apply(g, b) -> a = b) -> injective(g))
                  ...
                  @composite-is-pointwise-injective |
                    forall a, b: Element; apply(compose(g, f), a) = apply(compose(g, f), b) -> a = b
                    [by forall_intro generalize-a]
                  @composite-injective-unfolds |
                    (injective(compose(g, f)) -> (forall a, b: Element; apply(compose(g, f), a) = apply(compose(g, f), b) -> a = b))
                      and ((forall a, b: Element; apply(compose(g, f), a) = apply(compose(g, f), b) -> a = b) -> injective(compose(g, f)))
                    [by forall_elim(compose(g, f)) injective-unfolds]
                  @pointwise-injective-gives-injective |
                    (forall a, b: Element; apply(compose(g, f), a) = apply(compose(g, f), b) -> a = b) -> injective(compose(g, f))
            ...
            assume surjective(g) {
              @given-f-surjective |
                assume surjective(f) {
                  @surjective-unfolds |
                    forall h: Fn;
                      (surjective(h) -> (forall y: Element; exists x: Element; apply(h, x) = y))
                      and ((forall y: Element; exists x: Element; apply(h, x) = y) -> surjective(h))
                    [by axiom surjectiveDef]
                  @g-surjective-unfolds |
                    (surjective(g) -> (forall y: Element; exists x: Element; apply(g, x) = y))
                      and ((forall y: Element; exists x: Element; apply(g, x) = y) -> surjective(g))
                  ...
                  @composite-is-pointwise-surjective |
                    forall y: Element; exists x: Element; apply(compose(g, f), x) = y
                    [by forall_intro generalize-c]
                  @composite-surjective-unfolds |
                    (surjective(compose(g, f)) -> (forall y: Element; exists x: Element; apply(compose(g, f), x) = y))
                      and ((forall y: Element; exists x: Element; apply(compose(g, f), x) = y) -> surjective(compose(g, f)))
                    [by forall_elim(compose(g, f)) surjective-unfolds]
                  @pointwise-surjective-gives-surjective |
                    (forall y: Element; exists x: Element; apply(compose(g, f), x) = y) -> surjective(compose(g, f))
        ...
        assume invertible(f) {
          ...
          @with-inverse-g |
            unpack g: Fn from inverse-exists {
              ...
              @injective-unfolds |
                forall ff: Fn;
                  (injective(ff) -> (forall a, b: Element; apply(ff, a) = apply(ff, b) -> a = b))
                  and ((forall a, b: Element; apply(ff, a) = apply(ff, b) -> a = b) -> injective(ff))
                [by axiom injectiveDef]
              @f-injective-unfolds |
                (injective(f) -> (forall a, b: Element; apply(f, a) = apply(f, b) -> a = b))
                  and ((forall a, b: Element; apply(f, a) = apply(f, b) -> a = b) -> injective(f))
                [by forall_elim(f) injective-unfolds]
              @pointwise-injective-gives-injective |
                (forall a, b: Element; apply(f, a) = apply(f, b) -> a = b) -> injective(f)
        ...
        assume invertible(f) {
          ...
          @with-inverse-g |
            unpack g: Fn from inverse-exists {
              ...
              @surjective-unfolds |
                forall ff: Fn;
                  (surjective(ff) -> (forall y: Element; exists x: Element; apply(ff, x) = y))
                  and ((forall y: Element; exists x: Element; apply(ff, x) = y) -> surjective(ff))
                [by axiom surjectiveDef]
              @f-surjective-unfolds |
                (surjective(f) -> (forall y: Element; exists x: Element; apply(f, x) = y))
                  and ((forall y: Element; exists x: Element; apply(f, x) = y) -> surjective(f))
                [by forall_elim(f) surjective-unfolds]
              @pointwise-surjective-gives-surjective |
                (forall y: Element; exists x: Element; apply(f, x) = y) -> surjective(f)
    ...
    fix f: Fn {
      @given-bijective |
        assume injective(f) and surjective(f) {
          ...
          // injectivity as a usable implication: f(a)=f(b) -> a=b.
          @injective-def |
            forall ff: Fn;
              (injective(ff) -> (forall a, b: Element; apply(ff, a) = apply(ff, b) -> a = b))
              and ((forall a, b: Element; apply(ff, a) = apply(ff, b) -> a = b) -> injective(ff))
          ...
          @injective-def-at-f |
            (injective(f) -> (forall a, b: Element; apply(f, a) = apply(f, b) -> a = b))
              and ((forall a, b: Element; apply(f, a) = apply(f, b) -> a = b) -> injective(f))
            [by forall_elim(f) injective-def]
          @injective-forward |
            injective(f) -> (forall a, b: Element; apply(f, a) = apply(f, b) -> a = b)
            [by and_elim_left injective-def-at-f]
          @f-injective-pointwise |
            forall a, b: Element; apply(f, a) = apply(f, b) -> a = b
            [by modus_ponens injective-forward f-injective]

          // surjectivity as a usable statement: forall y; exists x; f(x)=y.
          @surjective-def |
            forall ff: Fn;
              (surjective(ff) -> (forall y: Element; exists x: Element; apply(ff, x) = y))
              and ((forall y: Element; exists x: Element; apply(ff, x) = y) -> surjective(ff))
          ...
          @surjective-def-at-f |
            (surjective(f) -> (forall y: Element; exists x: Element; apply(f, x) = y))
              and ((forall y: Element; exists x: Element; apply(f, x) = y) -> surjective(f))
            [by forall_elim(f) surjective-def]
          @surjective-forward |
            surjective(f) -> (forall y: Element; exists x: Element; apply(f, x) = y)
            [by and_elim_left surjective-def-at-f]
          @f-surjective-pointwise |
            forall y: Element; exists x: Element; apply(f, x) = y
            [by modus_ponens surjective-forward f-surjective]
          ...
          @total-unique-proof |
            fix b: Element {
              @exists-preimage |
                exists x: Element; apply(f, x) = b
                [by forall_elim(b) f-surjective-pointwise]
              @with-preimage |
                      ...
                      @given-f-a2-b |
                        assume apply(f, a2) = b {
                          ...
                          @inj-at-a2-a |
                            ...
                            [by forall_elim(a2, a) f-injective-pointwise]
                          @a2-is-a |
                            a2 = a
          ...
          @with-realizer |
            unpack g: Fn from realizer-exists {
              ...
              @compose-g-f-pointwise |
                fix a: Element {
                  ...
                  @inj-at-gfa-a |
                    ...
                    [by forall_elim(apply(g, apply(f, a)), a) f-injective-pointwise]
                  @g-f-a-is-a |
                    apply(g, apply(f, a)) = a
              ...
              @invertible-def |
                forall ff: Fn;
                  (invertible(ff) -> (exists gg: Fn; compose(gg, ff) = id and compose(ff, gg) = id))
                  and ((exists gg: Fn; compose(gg, ff) = id and compose(ff, gg) = id) -> invertible(ff))
                [by axiom invertibleDef]
              @invertible-def-at-f |
                (invertible(f) -> (exists gg: Fn; compose(gg, f) = id and compose(f, gg) = id))
                  and ((exists gg: Fn; compose(gg, f) = id and compose(f, gg) = id) -> invertible(f))
                [by forall_elim(f) invertible-def]
              @invertible-backward |
                (exists gg: Fn; compose(gg, f) = id and compose(f, gg) = id) -> invertible(f)
                [by and_elim_right invertible-def-at-f]
              @f-invertible |
                invertible(f)
