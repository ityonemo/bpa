                        ...
                        fix b: Element {
                          @given-composite-agrees |
                            assume apply(compose(g, f), a) = apply(compose(g, f), b) {
                              ...
                              @fa-equals-fb |
                                apply(f, a) = apply(f, b)
                                [by specialize g-is-pointwise-injective(apply(f, a), apply(f, b)) g-of-fa-equals-g-of-fb]
                              // f injective => a = b
                              @a-equals-b |
                                a = b
                                [by specialize f-is-pointwise-injective(a, b) fa-equals-fb]
                            }
                    ...
                    fix a2: Element {
                      @given-f-a2-b |
                        assume apply(f, a2) = b {
                          ...
                          @a2-is-a |
                            a2 = a
                            [by specialize f-injective(a2, a) f-a2-is-f-a]
                          @a-is-a2 |
                            a = a2
                            [by symmetry a2-is-a]
                        }
            ...
            unpack g: Fn from realizer-exists {
              ...
              @compose-g-f-pointwise |
                fix a: Element {
                  ...
                  @g-f-a-is-a |
                    apply(g, apply(f, a)) = a
                    [by specialize f-injective(apply(g, apply(f, a)), a) f-g-at-fa]
                  @compose-apply |
                    forall gg, ff: Fn; forall x: Element;
                      apply(compose(gg, ff), x) = apply(gg, apply(ff, x))
                    [by axiom composeApply]
