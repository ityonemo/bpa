...
pub fn addTests(
    ...
    ctx.ok(&.{ "check", "aata/groups.md" }, "OK: 29 declarations, 10 theorems proven\n");
    ...
    ctx.ok(&.{ "check", "aata/sets.md" }, "OK: 43 declarations, 14 theorems proven\n");
    ...
    ctx.ok(&.{ "check", "aata/functions.md" }, "OK: 36 declarations, 7 theorems proven\n");
}
