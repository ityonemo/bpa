...
pub fn addTests(
    ...
    for ([_][]const u8{ "examples/peano.bpa", "examples/peano-pure.bpa", "examples/peano-imports.bpa", "examples/gauss.bpa", "examples/gauss-pure.bpa", "examples/euclid.bpa", "examples/euclid-compute.bpa", "examples/incorrect.bpa", "examples/sqrt2.bpa", "std/peano.bpa", "std/peano-ordering.bpa", "std/peano-subtraction.bpa", "std/peano-division.bpa", "std/peano-gcd.bpa", "std/peano-parity.bpa", "std/group.bpa", "std/group-power.bpa", "std/ring.bpa", "std/integer-ring-model.bpa", "std/set.bpa", "std/function.bpa", "std/function-invertible.bpa", "std/integer.bpa", "std/integer-ring.bpa", "std/integer-order.bpa", "std/integer-divides.bpa", "std/divisibility.bpa", "std/integer-nonneg.bpa", "std/element.bpa", "std/relation.bpa", "std/equivalence.bpa", "aata/3.2-groups.md", "aata/1.2.1-sets.md", "aata/1.2.2-functions.md", "aata/1.2.3-relations.md", "aata/1.2.3-partitions.md", "aata/2-integers.md", "tests/cases/kebab_label_ok.bpa", "tests/cases/schema_eta.bpa", "tests/cases/schema_binary_param.bpa", "tests/cases/choice_description.bpa", "tests/cases/case_split.bpa", "tests/cases/fix_sibling_reuse.bpa", "tests/cases/outline.bpa", "tests/cases/assoc_commut_custom.bpa", "tests/cases/assoc_commut_bad_arity.bpa", "tests/cases/assoc_commut_oracle.bpa", "tests/cases/polynomial_oracle.bpa", "tests/cases/search_target.bpa", "tests/cases/assoc.bpa", "tests/cases/assoc_bad.bpa", "tests/cases/assoc_missing_arg.bpa", "tests/cases/assoc_oracle.bpa", "tests/cases/axiom_as_step_bad.bpa" }) |path| {
