...
pub fn addTests(
    ...
    for ([_][]const u8{ "examples/peano.bpa", "examples/peano-pure.bpa", "examples/peano-imports.bpa", "examples/gauss.bpa", "examples/gauss-pure.bpa", "examples/euclid.bpa", "examples/euclid-compute.bpa", "examples/incorrect.bpa", "examples/sqrt2.bpa", "std/peano.bpa", "std/peano-ordering.bpa", "std/peano-subtraction.bpa", "std/peano-division.bpa", "std/peano-gcd.bpa", "std/peano-parity.bpa", "std/group.bpa", "std/group-power.bpa", "std/ring.bpa", "std/set.bpa", "std/collection.bpa", "std/function.bpa", "std/function-invertible.bpa", "std/integer.bpa", "std/integer-order.bpa", "std/integer-wellordering.bpa", "std/integer-divides.bpa", "std/integer-division.bpa", "std/integer-gcd.bpa", "std/sequence.bpa", "std/integer-sequence.bpa", "std/primes.bpa", "std/divisibility.bpa", "std/element.bpa", "std/relation.bpa", "std/equivalence.bpa", "aata/3.2-groups.md", "aata/1.2.1-sets.md", "aata/1.2.2-functions.md", "aata/1.2.3-relations.md", "aata/1.2.3-partitions.md", "aata/2.1-induction.md", "aata/2.2-division-algorithm.md", "aata/2.3-primes.md", "tests/cases/kebab_label_ok.bpa", "tests/cases/schema_eta.bpa", "tests/cases/schema_binary_param.bpa", "tests/cases/schema_wellformed_ok.bpa", "tests/cases/schema_wellformed_bad.bpa", "tests/cases/choice_description.bpa", "tests/cases/model_accel_simplify.bpa", "tests/cases/model_accel_assoc.bpa", "tests/cases/model_accel_assoc_commut.bpa", "tests/cases/model_accel_tautology.bpa", "tests/cases/model_accel_polynomial.bpa", "tests/cases/model_accel_arithmetic.bpa", "tests/cases/model_accel_ext.bpa", "tests/cases/model_schema_source.bpa", "tests/cases/model_schema.bpa", "tests/cases/model_schema_bad.bpa", "tests/cases/case_split.bpa", "tests/cases/fix_sibling_reuse.bpa", "tests/cases/outline.bpa", "tests/cases/query_claims_schema.bpa", "tests/cases/model_obligation_arrow.bpa", "tests/cases/model_axiom_colon_bad.bpa", "tests/cases/model_symbol_arrow_bad.bpa", "tests/cases/schema_accelerant_polynomial.bpa", "tests/cases/arithmetic_fallback_redundant_bad.bpa", "tests/cases/schema_arithmetic_fallback_bad.bpa", "tests/cases/schema_arithmetic_param_bad.bpa", "tests/cases/assoc_commut_custom.bpa", "tests/cases/assoc_commut_bad_arity.bpa", "tests/cases/assoc_commut_oracle.bpa", "tests/cases/polynomial_oracle.bpa", "tests/cases/search_target.bpa", "tests/cases/assoc.bpa", "tests/cases/assoc_bad.bpa", "tests/cases/assoc_missing_arg.bpa", "tests/cases/assoc_oracle.bpa", "tests/cases/axiom_as_step_bad.bpa" }) |path| {
